...
public class YellowLight : MonoBehaviour {
    ...
    private float radius = LightBlinker.radius;
    ...
    void Start() {
        ...
        // Set circle colour
        mr.material.color = new Color(0.6f, 0.6f, 0.1f, 0.3f);
            ...
            foreach (RaycastHit2D hit in hits) {
                if (hit.collider != null) {
                    if (hit.collider.CompareTag("Enemy")) {
                        ...
                        hit.transform.SendMessage("HitByYellowRay", gameObject);
                    }
    ...
    /*void OnDrawGizmos() {
        ...
        //Other vertices positioned evenly around the circle
        for (int i = 1; i <= numPoints; i++) {
            ...
            // Increase the angle to reach the next vertex on the circle
            alpha += delta;
        }
    }*/
}